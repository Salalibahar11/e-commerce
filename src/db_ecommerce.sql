...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 27, 2025 at 08:50 AM
...
(1, 'admin1', 'faisalalibahar714@gmail.com', 'rahasia');
...
CREATE TABLE `payments` (
  ...
  `payment_method` enum('E-Wallet','Bank Transfer','Virtual Account') NOT NULL,
  `payment_status` enum('Menunggu pembayaran','Dibayar','dibatalkan') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `transactions` (
  ...
  `status` enum('Menunggu Pembayaran','Sudah Dibayar','Dibatalkan') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
